...
# Author: ricocheting
# (micah made the class name lowercase, to fit conventions, and added num_rows function)
...
#-#############################################
# desc: returns how many rows of results there are
# param: query_id for mysql run. if none specified, last used
...
function num_rows($query_id=-1) {
	...
	if (isset($this->query_id)) {
		...
		$this->oops("Invalid query_id: <b>$this->query_id</b>. Num rows could not be determined.");
	}
}
